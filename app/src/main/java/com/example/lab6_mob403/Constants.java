...
public class Constants {
    ...
    public final static String C_TO_F_SOAP_ACTION = SOAP_ACTION +
            C_TO_F_METHOD_NAME;
//
//    public final static String F_TO_C_SOAP_ACTION = "https://www.w3schools.com/xml/tempconvert.asmx?op=CelsiusToFahrenheit";
//
//    public final static String C_TO_F_SOAP_ACTION = "https://www.w3schools.com/xml/tempconvert.asmx?op=FahrenheitToCelsius";
}
